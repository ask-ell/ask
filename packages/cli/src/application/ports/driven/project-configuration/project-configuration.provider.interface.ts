...
export interface IProjectConfigurationProvider extends IAggregateRootProvider<IProjectConfigurationState, IProjectConfigurationState> {
    findOneFromPartialState(partialState: IProjectConfigurationPartialState): Promise<MaybeUndefined<IProjectConfigurationState>>;
}
